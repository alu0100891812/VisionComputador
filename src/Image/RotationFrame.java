...
public class RotationFrame extends JFrame {
	...
	public RotationFrame(String title) {
		setTitle(title);
		...
		Integer[] posDegrees = {90,180,270};
		
		JComboBox<Integer> comboBox = new JComboBox<>(posDegrees);
		comboBox.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				degrees = ((Integer)comboBox.getSelectedItem()).intValue();
			}
		});
